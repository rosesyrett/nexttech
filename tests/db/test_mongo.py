...
def test_aggregate_features(mongo_client, monkeypatch):
    ...
    monkeypatch.setattr(
        os, "environ", {"MONGO_ATLAS_USERNAME": "foo", "MONGO_ATLAS_PASSWORD": "bar"}
    )
    ...
    features = [
        ...
        },
        {
            ...
            "json": {
                ...
                "last_editor": "someone",
                "last_checked": 123456,
                "last_modified": 789101112,
                "date_start": None,
                "date_end": None,
            },
        },
        {"name": "abc", "range_key": "last_checked", "last_checked": 789101112},
    ]

    def fake_feature_iterator():
        for feature in features:
            if feature.get("json"):
                feature["json"] = json.dumps(feature["json"])
            yield feature
